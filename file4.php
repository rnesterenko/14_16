...
<h3 align="center"><a href="index.php" title="Главная страница">Главная</a>|
   ...
   <table border="0" align="center">
      <div>
          <label for="uname">Ваше имя *:</label><input type="text" name="uname" value=""  size="50" maxlength="30" placeholder="введите Ваше имя" required>
      </div>
      <div>
          <label for="umail">Email *   :</label><input type="email" name="umail" value=""  size="50" maxlength="30" placeholder="введите Ваш мейл" required>
      </div>
       <div>
           <label for="utel">Телефон *  :</label><input type="phone" id="utel" name="utel" value=""  size="50" maxlength="30" placeholder="Введите Ваш номер телефона" required>
       </div>
